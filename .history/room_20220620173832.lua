...
function Room:new(length, height, entrance, exit)
    local r = {}
    setmetatable(r, self)
    self.__index = self
    ...
    r.objectsGrid[entrance[1]][entrance[2]] = "entrance" -- à ajuster en fonction de la forme de spawn (ici je considère que c'est juste un tableau avec x et y dedans)
    r.objectsGrid[exit[1]][exit[2]] = "exit"

        ...
        for c = 1, map_width do
            ...
            if collision_tiles_list[tile.data] then
                ...
                if wall_type == "full" then
                    tile.hitbox=Hitbox:new(Vector:new((c-1)*8 + r.tileSize, (l-1)*8 + r.tileSize), "hitbox", 8, 8, Vector:new(0, 0))
                elseif wall_type == "right" then
                    tile.hitbox=Hitbox:new(Vector:new((c-1)*8 + r.tileSize + 4, (l-1)*8 + r.tileSize), "hitbox", 4, 8, Vector:new(0, 0))
                elseif wall_type == "left" then
                    tile.hitbox=Hitbox:new(Vector:new((c-1)*8 + r.tileSize, (l-1)*8 + r.tileSize), "hitbox", 4, 8, Vector:new(0, 0))
                else
